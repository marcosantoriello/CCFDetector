...
\section{Data Preparation}
    ...
    \subsection{Data Cleaning}
        ...
        La feture \textit{Amount}, contenente l'importo di ogni transazione in dollari, non risulta essere in formato numerico, per cui vado a convertirne tutti i suoi valori in float, non prima di aver rimosso il simbolo della valua che precede le cifre.\\
        Gestisco, infine, la caratteristica \textit{Time} che, siccome non posso convertire in intero, provvedo a dividere nelle caratteristiche \textit{Hour} e \textit{Minute}, rimuovendola, infine dal dataset.
